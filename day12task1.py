...
# paskutinė eilutė neprisiskaičiuoja, gal _ vertina eilutę kaip tarpą tarp dviejų
# eilutės perkėlimų, arba automatiškai 1 numinusuoja gal..
# galima būtų naudoti ir len(f.readlines()), bet tuo atveju nuskaitymui
# naudojama atmintis RAM ir dideliam failui neefektyvu
...
# text_new = get_text_lines("sherlock_holmes_adventures.txt")
# print(text_new[:10])
# print("just anything")
#  it works now but didn't work for a while before getting a message about vscode update
...
#         newl = f.writelines(lines)
#     return newl

# destpath="hmmm.txt"
# lines =["I wish \n", "I had more \n", "time \n", "to reflect \n", "on everything \n"]

# print(save_lines(destpath, lines))
...
#         # i did by example this time just have no time at this stage to proper catch up as in putting togehter own solution
#         for line in fin:
#             for charr in line:
#                 if charr in string.punctuation:
