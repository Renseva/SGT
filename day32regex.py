...
"""
# match_phones = re.findall(r"[+]+[0-9]+[(]+[0-9]+[-.)]+[0-9]+[-.]+[0-9]", phone_text)
# match_phones = re.findall(r"[+]+\d+[(]+\d+[-.)]+\d+[-.]+\d+", phone_text)
# match_phones = re.findall(r".\d+\d+.\d+\d+.\d+\d+.\d+\d+|.\d+\d+.\d+\d+.\d+\d+|.\d+\d+.\d.\d+\d+.\d+\d+|1.\d+\d+.\d+\d+.\d+\d+|[\(]d+\d+[\)]\d+\d+.\d+\d+", phone_text)
match_phones = re.findall(r".\d+\d+.\d+\d+.\d+\d+.\d+\d+|.\d+\d+.\d+\d+.\d+\d+|.\d+\d+.\d.\d+\d+.\d+\d+|1.\d+\d+.\d+\d+.\d+\d+|.d+\d+.\d+\d+.\d+\d+", phone_text)
